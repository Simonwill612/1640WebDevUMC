...
namespace _1640WebDevUMC.Controllers
{
    public class ContributionsController : Controller
    {
        ...
        {
            ViewData["YearID"] = new SelectList(_context.AcademicYears, "YearID", "YearID");
        ...
        public async Task<IActionResult> Create([Bind("ContributionID,UserID,Title,Content,UploadDate,ClosureDate,FinalClosureDate,Status,Comment,SelectedForPublication,YearID")] Contribution contribution)
        {
            ...
            ViewData["YearID"] = new SelectList(_context.AcademicYears, "YearID", "YearID", contribution.YearID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContributionID,UserID,Title,Content,UploadDate,ClosureDate,FinalClosureDate,Status,Comment,SelectedForPublication,YearID")] Contribution contribution)
        {
