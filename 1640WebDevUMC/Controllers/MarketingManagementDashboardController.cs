...
namespace _1640WebDevUMC.Controllers
{
    public class MarketingManagementDashboardController : Controller
    {
        ...
        public MarketingManagementDashboardController(RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            foreach (var user in users)
            {
                ...
                {
                    var faculties = await _context.Faculties.Where(f => f.Users.Any(u => u.Id == user.Id)).Select(f => f.FacultyName).ToListAsync(); // Get the faculty names
